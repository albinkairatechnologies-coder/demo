...
Use web search to look up: the business name + town on Google/Maps, the search "${cat} ${town}" to see who ranks at the top, and their website/social profiles if provided. Base your assessment on what you can actually find; if you cannot find something, treat it as missing/weak.
...
Assess these 5 areas. "status" must be "green" (strong), "amber" (needs work) or "red" (missing/urgent):
1. Google Business Profile  2. Search Ranking (do they appear for "${cat} ${town}"?)  3. Reviews & Reputation  4. Website  5. Social Media & Ads

Write for a non-technical small business owner. Very simple, warm, encouraging, ZERO jargon. Frame every gap as a fixable "quick win", never an insult.

Reply with ONLY valid JSON, no markdown, no extra words:
{"overallScore":<0-100 integer>,"grade":"<Needs Urgent Work|Getting There|Strong>","headline":"<one warm sentence on where they stand>","categories":[{"name":"Google Business Profile","status":"red|amber|green","note":"<max 12 words>"},{"name":"Search Ranking","status":"...","note":"..."},{"name":"Reviews & Reputation","status":"...","note":"..."},{"name":"Website","status":"...","note":"..."},{"name":"Social Media & Ads","status":"...","note":"..."}],"quickWin":"<the single most important fix, one sentence>","summary":"<2 plain sentences: what is holding them back and the opportunity>"}`;
